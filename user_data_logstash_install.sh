...
sed -i 's|# queue.max_bytes: 1024mb|queue.max_bytes: 1024mb|' /etc/logstash/logstash.yml
sed -i 's|# dead_letter_queue.enable: false|dead_letter_queue.enable: true|' /etc/logstash/logstash.yml
sed -i 's|# dead_letter_queue.max_bytes: 1024mb|dead_letter_queue.max_bytes: 1024mb|' /etc/logstash/logstash.yml
